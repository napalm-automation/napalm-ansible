...
DOCUMENTATION = '''
---
module: napalm_get_interfaces
author: "Elisa Jasinska (@fooelisa)"
version_added: "2.1.0"
short_description: "Gathers interfaces from a network device"
description:
    - "Gathers interfaces from a network device via the Python module napalm"
requirements:
    - napalm
options:
    hostname:
